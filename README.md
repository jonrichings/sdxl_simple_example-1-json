# sdxl_simple_example-1-json

Dockerized ComfyUI workflow: sdxl_simple_example (1).json
...
docker build -t sdxl_simple_example-1-json .

# Run the container
docker run -p 8188:8188 sdxl_simple_example-1-json
```
